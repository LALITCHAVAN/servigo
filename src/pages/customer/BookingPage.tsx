...
export function BookingPage() {
  ...
  const initialPro =
    prosList.find(
      (p) => p.id === searchParams.get('professional')
    );
  ...
  const [selectedPro, setSelectedPro] =
    useState(initialPro || prosList[0]);

  const [selectedDate, setSelectedDate] =
    useState(dates[0]);

  const [selectedTime, setSelectedTime] =
    useState(timeSlots[0]);

  // This is the SERVICE ADDRESS.
  // It is separate from the live GPS address.
  const [address, setAddress] = useState(
    user?.location ||
      'Flat 201, Sunrise Apartments, Koregaon Park, Pune'
  );
  ...
  // Readable address generated from current GPS coordinates
  ...
  // Prevent unnecessary reverse-geocoding requests.
  const lastGeocodedLocationRef =
    useRef<{
      latitude: number;
      longitude: number;
    } | null>(null);
  ...
  const getAddressFromCoordinates = async (
    ...
    // Don't call reverse geocoding for tiny GPS changes.
    if (previous) {
      ...
      // Roughly prevents requests for very small movement.
      if (
    ...
    createBooking.mutate(
      ...
      },
      {
        onSuccess: (booking: any) => {
          // Use the REAL MongoDB booking ID
          const realBookingId =
            booking?._id ||
            booking?.id;
  ...
  return (
    <div className="pt-24 lg:pt-28 pb-16 min-h-screen bg-ink-50">
      <div className="container-page max-w-4xl">
        ...
        <h1 className="font-sans font-extrabold text-3xl text-ink-900 mb-2">
          Book a Service
        </h1>

        <p className="text-ink-500 mb-8">
          Complete the steps below to book your service.
        </p>
        ...
        <AnimatePresence mode="wait">
          ...
          {!confirmed ? (
            ...
            >
              ...
              {step === 0 && (
                <div>
                  ...
                  <h2 className="font-sans font-bold text-xl text-ink-900 mb-4">
                    Choose a Service
                  </h2>
                    ...
                    {(availablePros.length > 0
                      ...
                      >
                        ...
                        <div className="text-right shrink-0">
                          ...
                          {selectedPro?.id ===
                            pro.id && (
                            <Check className="w-5 h-5 text-primary-600 ml-auto mt-1" />
                          )}
            ...
            >
              ...
              <h2 className="font-sans font-extrabold text-2xl text-ink-900">
                Booking Confirmed!
              </h2>

              <p className="mt-2 text-ink-500">
                Your service has been booked successfully.
                You can now share your live location with
              ...
              <div className="max-w-md mx-auto mt-6 rounded-2xl border border-ink-200 overflow-hidden text-left">
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-ink-500 mt-1">
                        {locationSharing
                          ? 'Your current location is being shared with your assigned professional.'
                          : 'Share your current GPS location so your professional can find you.'}
                      </p>
                  ...
                  {/* CURRENT GPS + ACTUAL ADDRESS */}

                  {currentLocation && (
                    <div className="mt-4 rounded-xl bg-ink-50 p-3 text-xs space-y-2">

                      {/* ACTUAL ADDRESS */}

                      <div className="pb-3 mb-2 border-b border-ink-200">
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="font-medium text-ink-900 leading-relaxed">
                  ...
                  {locationError && (
                    <div className="mt-4 rounded-xl bg-error-50 border border-error-100 p-3">
                  ...
                  <p className="text-[11px] text-ink-400 mt-3 text-center">
                    Your live location is shared only
                    with the professional assigned to
                    this booking.
                  </p>
          ...
          <div className="flex items-center justify-between mt-6">
            ...
            {step < 3 ? (
              ...
              >
                ...
                {createBooking.isPending
                  ? 'Processing...'
                  : `Confirm & Pay ₹${selectedService?.startingPrice || 0}`}
